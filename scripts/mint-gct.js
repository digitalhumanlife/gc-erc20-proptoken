...
async function mintgc() {
    ...
    const tokenValue1 = "100000000000000000"
    ...
    const gcToken0 = await ethers.getContract("GCPropTokenTestDao", account0)
    ...
    // const gcToken1 = await ethers.getContract("GCPropTokenTestDao", account1)
    ...
    // const gcToken2 = await ethers.getContract("GCPropTokenTestDao", account2)
